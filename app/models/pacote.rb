class Pacote < ApplicationRecord
  ...
  # Remova qualquer callback que modifique o valor
  # before_validation :calcular_valor, if: -> { valor.blank? }

  private

  # Remova qualquer método que modifique o valor
  # def calcular_valor
  #   self.valor = servicos_adicionais.sum(&:valor)
  # end
end